...
from idelib.transforms import Transform, Univariate, Bivariate
...
class PolyEditDialog(SC.SizedDialog):
    ...
    def _addfield(self, label, default=None, lines=1, **kwargs):
        ...
        t = wx.TextCtrl(subpane, -1, str(default), **kwargs)
    ...
    def __init__(self, parent, wxId, cal=None, channels=None, transforms=None,
...
#         self.SetButtonSizer(self.CreateStdDialogButtonSizer(wx.OK | wx.CANCEL))
    ...
    def onRevert(self, _evt):
        """ Handle reverting to saved data.
        """
        if self.savedCal is None:
            return
